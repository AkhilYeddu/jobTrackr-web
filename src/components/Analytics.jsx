  ...
  return (
    <div>
          ...
          <div className="flex-col">
            ...
            <div className="flex p-4 items-center bg-base-300 rounded-lg p-4 m-2">
              <h1 className="w-40">Applied</h1>
                <progress className="progress rounded-lg w-56 h-4 mr-3" value="100" max="100"></progress>
                <span>42</span>
            </div>

            <div className="flex p-4 items-center bg-base-300 rounded-lg p-4 m-2">
              <h1 className="w-40">OA / screening</h1>
                <progress className="progress rounded-lg w-56 h-4 mr-3" value="78" max="100"></progress>
                <span>25</span>
            </div>
            ...
            <div className="flex p-4 items-center bg-base-300 rounded-lg p-4 m-2">
              <h1 className="w-40">Interview</h1>
                <progress className="progress rounded-lg w-56 h-4 mr-3" value="43" max="100"></progress>
                <span>11</span>
            </div>
