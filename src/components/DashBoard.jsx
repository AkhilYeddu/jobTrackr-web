  ...
  return (
    <div className="dashboard flex">
        ...
        <div className="applied m-5">
            ...
            <div className="card w-96 bg-base-300 card-sm shadow-sm rounded-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer">
    ...
    <div className="interview m-5">
        ...
        <div className="card w-96 bg-base-300 card-sm shadow-sm rounded-xl border-1 border-blue-400 transition-all duration-300 hover:-translate-y-2 cursor-pointer">
        <div className="card-body">
    ...
    <div className="offer m-5">
        ...
        <div className="card w-96 bg-base-300 card-sm shadow-sm rounded-xl rounded-xl border-1 border-green-400 bg-green-900 transition-all duration-300 hover:-translate-y-2 cursor-pointer">
        <div className="card-body">
            <h2 className="card-title text-green-400 font-bold text-xl">Meesho!</h2>
            <p className="text-green-400 font-bold ">Offer Received</p>
            <div className="justify-end card-actions">
                    <details className="dropdown ">
                <summary className="btn m-1 btn-primar border rounded-xl btn-disabled">open or close</summary>
                <ul className="menu dropdown-content bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
                    <li><a>Item 1</a></li>
                    <li><a>Item 2</a></li>
                </ul>
